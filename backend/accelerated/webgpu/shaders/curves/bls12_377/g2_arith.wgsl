...
// 5·x, used to reduce u² = -5.
fn fp_mul_by_5(x: Fp) -> Fp {
  return fp_add(fp_double(fp_double(x)), x);
}

// Karatsuba: (a0 + a1 u)(b0 + b1 u) = (a0b0 - 5·a1b1) + ((a0+a1)(b0+b1) - a0b0 - a1b1) u
...
// (c0 + c1 u)² = (c0² - 5·c1²) + 2c0c1 u, with c0² - 5·c1² = (c0 + c1)(c0 - 5·c1) + 4c0c1.
